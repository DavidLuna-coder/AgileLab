...
namespace TFG.Migrations
{
    ...
    [Migration("20250123190048_AddedSonarQubeProjectKeyToProjects")]
    partial class AddedSonarQubeProjectKeyToProjects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TFG.Model.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PermissionRol", b =>
                {
                    b.HasOne("TFG.Model.Entities.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TFG.Model.Entities.Rol", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectUser", b =>
                {
                    b.HasOne("TFG.Model.Entities.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TFG.Model.Entities.Notification", b =>
                {
                    b.HasOne("TFG.Model.Entities.Project", "Project")
